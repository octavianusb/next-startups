...
// Query: *[_type == 'startup' && defined(slug.current) && !defined($search) || title match $search || category match $search || author->name match $search] | order(_createdAt desc) {        _createdAt,        _id,        author -> {            _id,            bio,            image,            name,        },        category,        description,        image,        slug,        title,        views,    }
...
// Query: *[_type == 'startup' && _id == $id][0]{        _createdAt,        _id,        author -> {            _id,            bio,            image,            name,            username,        },        category,        description,        image,        slug,        title,        views,        pitch,    }
...
// Query: *[_type == 'author' && id == $id][0]{        _id,        id,        bio,        email,        image,        name,        username,    }
...
// Query: *[_type == 'author' && _id == $id][0]{        _id,        id,        bio,        email,        image,        name,        username,    }
...
// Query: *[_type == 'startup' && defined(slug.current) && author._ref == $id] | order(_createdAt desc) {        _createdAt,        _id,        author -> {            _id,            bio,            image,            name,        },        category,        description,        image,        slug,        title,        views,    }
